...
| macOS | **drawing, pass-through and the chord work**, seen on one Retina Mac: the overlay stays above other apps and the shape tools draw ([E011](docs/evidence/E011-first-macos-drawing.md)), and Control+Option+D brings it back from pass-through ([E013](docs/evidence/E013-macos-global-chord.md)). The first launch, on 0.6.0, appeared to freeze, for reasons since fixed ([E009](docs/evidence/E009-first-macos-launch.md)). In pass-through the apps underneath can be used; hide and fullscreen work too ([E014](docs/evidence/E014-hide-and-fullscreen.md)). Spaces are not yet confirmed |
